...
test("Is App renderering", async () => {
    mockFetchShow.mockResolvedValueOnce(showData)

  render(<App />)
})

test("Will this activate debug and check for title in App?", async () => {
  mockFetchShow.mockResolvedValueOnce(showData)
...
test("Will click dropdown button?", async () => {
  mockFetchShow.mockResolvedValueOnce(showData)
...
test("Does it click select dropdown button?", async () => {
  mockFetchShow.mockResolvedValueOnce(showData)
...
test("Do episodes render?", async () => {
  ...
  getByText(/Chapter Three: Holly, Jolly/i)
  getByText(/Chapter Four: The Body/i)
  getByText(/Chapter Five: The Flea and the Acrobat/i)
  getByText(/Chapter Six: The Monster/i)
  getByText(/Chapter Seven: The Bathtub/i)
  getByText(/Chapter Eight: The Upside Down/i)
})